...
actions = {
    ...
    'cloud': ['action', 'create', 'destroy', 'network_create', 'profile_', 'virtual_interface_create', 'volume_attach', 'volume_create', 'volume_delete', 'volume_detach'],
    ...
    'file': ['access', 'chgrp', 'chown', 'directory_exists', 'file_exists', 'find', 'manage_file', 'mkdir', 'remove', 'replace', 'search', 'symlink', 'touch', 'truncate'],
    ...
    'saltutil': ['sync_all', 'sync_modules', 'sync_grains', 'sync_outputters', 'sync_renderers', 'sync_returners', 'sync_states', 'sync_utils'],
