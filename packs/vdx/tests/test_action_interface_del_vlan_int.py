...
class TestInterfaceDelVlanInt(BaseActionTestCase):
    """Test holder class
    """
    ...
    def test_action(self):
        ...
        expected_xml = (
            ...
            'face"><interface><vlan operation="delete"><name>44</name></vlan><'
            '/interface></interface-vlan></config>'
        )
