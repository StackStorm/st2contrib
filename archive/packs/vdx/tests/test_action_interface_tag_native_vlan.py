...
class TestInterfaceTagNativeVlan(BaseActionTestCase):
    """Test holder class
    """
    ...
    def test_action(self):
        ...
        expected_xml = (
            ...
            '><tengigabitethernet><name>10/0/1</name><switchport><trunk><tag><'
            'native-vlan /></tag></trunk></switchport></tengigabitethernet></i'
            'nterface></config>'
        )
